...
module.exports = async (ctx, next) => {
    ...
    if (ctx.request && ctx.request.header && ctx.request.header.authorization) {
        ...
        try {
            ...
            administrator = await strapi.services.administrator.findOne({ _id: id });
            redactor = await strapi.services.redactor.findOne({ _id: id });
        ...
        if (!ctx.state.user && !administrator && !redactor) {
